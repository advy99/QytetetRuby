...
module ModeloQytetet
    ...
    class Qytetet
        ...
        def inicializarCartasSorpresa
            ...
            mazo << Sorpresa.new("Por ser tan buen programador te damos un premio" +
                    " de 1000 euros", 1000, TipoSorpresa::PAGARCOBRAR);

            mazo << Sorpresa.new("Es tu cumpleaños y tus compañeros son generosos," +
                   " cada jugador te da 200 euros", 200, TipoSorpresa::PORJUGADOR);

            mazo << Sorpresa.new("No era tu cumpleaños, ¡mentiroso!. Debes darle" +
                   " a los demás lo que te han dado con intereses, 300 euros a cada uno",
                   -300, TipoSorpresa::PORJUGADOR);
            mazo << Sorpresa.new("Eres muy emprendedor, obtienes 100 euros por "+
                   "cada casa y hotel que poseas", 100, TipoSorpresa::PORCASAHOTEL);

            mazo << Sorpresa.new("Tienes demasiadas propiedades, deja algo para" +
